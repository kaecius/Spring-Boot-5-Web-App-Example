...
@Entity
@Table(name = "tags", schema = "movielens", catalog = "")
@IdClass(TagPK.class)
public class Tag {
    private int userId;
    private int movieId;
    ...
    public boolean equals(Object o) {
        ...
        if (userId != tag1.userId) return false;
        if (movieId != tag1.movieId) return false;
        if (tag != null ? !tag.equals(tag1.tag) : tag1.tag != null) return false;
        if (timestamp != null ? !timestamp.equals(tag1.timestamp) : tag1.timestamp != null) return false;
